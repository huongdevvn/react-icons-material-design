...
export default function IconLinkedCameraTwoTone({ size = '1em', color = 'currentColor', ...restProps }) {
  return (
    <svg
    ...
    <path d='M20 20H4V8h4.05l1.83-2H15V4H9L7.17 6H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V9h-2v11zM16 2v1.33c2.58 0 4.66 2.09 4.67 4.66H22A6.003 6.003 0 0 0 16 2zm0 2.67V6c1.11 0 1.99.89 2 1.99h1.33A3.327 3.327 0 0 0 16 4.67z' />
    <path
