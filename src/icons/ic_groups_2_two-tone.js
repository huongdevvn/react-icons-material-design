...
export default function icGroups2TwoTone({ ...restProps }) {
  return (
    <svg
    ...
    >
      <path
        d='M15.43 15.48c-1.1-.49-2.26-.73-3.43-.73-1.18 0-2.33.25-3.43.73-.23.1-.4.29-.49.52h7.85a.978.978 0 0 0-.5-.52zM12.94 8.79C12.86 8.33 12.47 8 12 8s-.86.33-.94.79l-.2 1.21h2.28l-.2-1.21z'
        opacity='.3'
      />
