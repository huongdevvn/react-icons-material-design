...
export default function IconRememberMeTwoTone({ size = '1em', color = 'currentColor', ...restProps }) {
  return (
    <svg
    ...
    <path
      d='M7 20h10v1H7zm0-2.48V18h10v-.48c-1.47-.99-3.22-1.52-5-1.52s-3.53.53-5 1.52z'
      opacity={0.3}
    />
    <circle cx={12} cy={10} r={1} opacity={0.3} />
    <path d='M7 3h10v1H7z' opacity={0.3} />
