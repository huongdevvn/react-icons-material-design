...
export default function IconSpeakerGroupRound({ size = '1em', color = 'currentColor', ...restProps }) {
  return (
    <svg
    ...
    <path d='M5 5c-.55 0-1 .45-1 1v15a2 2 0 0 0 2 2h9c.55 0 1-.45 1-1s-.45-1-1-1H7c-.55 0-1-.45-1-1V6c0-.55-.45-1-1-1z' />
