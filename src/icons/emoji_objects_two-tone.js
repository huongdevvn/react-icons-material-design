...
export default function IconEmojiObjectsTwoTone({ size = '1em', color = 'currentColor', ...restProps }) {
  return (
    <svg
    ...
    <path d='M10 18h4v1h-4zm0-2h4v1h-4z' opacity={0.3} />
    ...
    <path d='m9.672 9.58.707-.706 2.122 2.121-.707.707z' />
    <path d='m12.208 11.712-.707-.707 2.121-2.121.707.707z' />
