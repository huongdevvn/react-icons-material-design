...
export default function icLyricsTwoTone({ ...restProps }) {
  return (
    <svg
    ...
    >
      <path
        ...
        opacity='.3'
      />
      <path d='M6 12h4v2H6zM6 6h7v2H6z' />
      ...
      <path d='M6 9h7v2H6zM20 6.18c-.31-.11-.65-.18-1-.18-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3V3h2V1h-4v5.18z' />
    </svg>
  );
}
