...
export default function IconCloudCircleTwoTone({ size = '1em', color = 'currentColor', ...restProps }) {
  return (
    <svg
    ...
    <path
      d='M12 4c-4.41 0-8 3.59-8 8s3.59 8 8 8 8-3.59 8-8-3.59-8-8-8zm4.08 12H8.5a3.5 3.5 0 0 1-.38-6.98 4.373 4.373 0 0 1 8.17 1.16c1.52.1 2.71 1.35 2.71 2.89 0 1.62-1.31 2.93-2.92 2.93z'
      opacity={0.3}
    />
