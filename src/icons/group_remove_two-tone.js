...
export default function IconGroupRemoveTwoTone({ size = '1em', color = 'currentColor', ...restProps }) {
  return (
    <svg
    ...
    <path
      d='M8 10c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm6 8H2v-.99C2.2 16.29 5.3 15 8 15s5.8 1.29 6 2v1z'
      opacity={0.3}
    />
