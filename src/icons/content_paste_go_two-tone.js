...
export default function IconContentPasteGoTwoTone({ size = '1em', color = 'currentColor', ...restProps }) {
  return (
    <svg
    ...
    <path d='M10 17c0-3.31 2.69-6 6-6h3V5h-2v3H7V5H5v14h5v-2z' opacity={0.3} />
