...
export default function icWatchOffTwoTone({ ...restProps }) {
  return (
    <svg
    ...
    >
      <path
        d='M13.89 5.27 13.51 4h-3.02l-.38 1.27c1.82-.51 3.23-.16 3.78 0zM10.11 18.73l.38 1.27h3.02l.38-1.27c-1.82.51-3.23.16-3.78 0z'
        opacity='.3'
      />
