...
export default function IconPersonOffTwoTone({ size = '1em', color = 'currentColor', ...restProps }) {
  return (
    <svg
    ...
    <path
      d='m15.17 18-3-3H12c-2.37 0-4.29.73-5.48 1.34-.32.16-.52.5-.52.88V18h9.17zM10.13 7.3A1.99 1.99 0 0 1 12 6c1.1 0 2 .9 2 2 0 .86-.54 1.59-1.3 1.87'
      opacity={0.3}
    />
