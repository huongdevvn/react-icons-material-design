...
export default function icFaceRetouchingNaturalTwoTone({ ...restProps }) {
  return (
    <svg
    ...
    >
      <path
        d='M10.66 4.12c2.55 4.23 7.03 3.87 7.18 3.86l-.57-1.25L12.4 4.5l.85-.39C12.84 4.04 12.43 4 12 4c-.46 0-.91.05-1.34.12zM8.08 5.03a8.046 8.046 0 0 0-3.66 4.44 8.046 8.046 0 0 0 3.66-4.44z'
        opacity='.3'
      />
