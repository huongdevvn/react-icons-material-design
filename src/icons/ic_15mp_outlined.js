...
export default function ic15mpOutlined({ ...restProps }) {
  return (
    <svg
    ...
    >
      ...
      <path d='M8.5 11.5H10v-6H7V7h1.5zM16.5 10.5V9c0-.55-.45-1-1-1h-2V7h3V5.5H12V9h3v1h-3v1.5h3.5c.55 0 1-.45 1-1z' />
    </svg>
  );
}
