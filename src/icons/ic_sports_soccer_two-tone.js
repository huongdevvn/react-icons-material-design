...
export default function icSportsSoccerTwoTone({ ...restProps }) {
  return (
    <svg
    ...
    >
      <path
        d='M7.01 9.49 11 6.7V5.3l-1.35-.95a8.103 8.103 0 0 0-4.38 3.34l.39 1.34 1.35.46zM5.01 10.92l-1 .73c0 .12-.01.23-.01.35 0 1.99.73 3.81 1.94 5.21l1.14-.1.79-1.37L6.4 11.4l-1.39-.48zM18.34 9.03l.39-1.34a8.067 8.067 0 0 0-4.38-3.34L13 5.3v1.4l3.99 2.79 1.35-.46zM8.37 10.98 9.73 15h4.54l1.36-4.02L12 8.44zM9.45 17l-.64 1.11.69 1.49c.79.25 1.63.4 2.5.4s1.71-.15 2.5-.41l.69-1.49-.64-1.1h-5.1zM19.98 11.65l-1-.73-1.38.48-1.46 4.34.79 1.37 1.14.1C19.27 15.81 20 13.99 20 12c0-.12-.01-.23-.02-.35z'
        opacity='.3'
      />
