...
export default function icShapeLineFilled({ ...restProps }) {
  return (
    <svg
      ...
      {...restProps}
    >
      <path d='M6 11c2.76 0 5-2.24 5-5S8.76 1 6 1 1 3.24 1 6s2.24 5 5 5zM21 14h-5c-1.1 0-2 .9-2 2v5c0 1.1.9 2 2 2h5c1.1 0 2-.9 2-2v-5c0-1.1-.9-2-2-2z' />
