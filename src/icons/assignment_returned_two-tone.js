...
export default function IconAssignmentReturnedTwoTone({ size = '1em', color = 'currentColor', ...restProps }) {
  return (
    <svg
    ...
    <path d='M5 19h14V5H5v14zm5-7V8h4v4h3l-5 5-5-5h3z' opacity={0.3} />
