...
export default function icFireTruckTwoTone({ ...restProps }) {
  return (
    <svg
    ...
    >
      <path
        d='M3 16h1.78c.55-.61 1.34-1 2.22-1s1.67.39 2.22 1H12v-3H3v3zM14 16h.78c.55-.61 1.34-1 2.22-1s1.67.39 2.22 1H21v-3h-7v3z'
        opacity='.3'
      />
