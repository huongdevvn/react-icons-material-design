...
export default function icHandymanTwoTone({ ...restProps }) {
  return (
    <svg
    ...
    >
      <path
        d='m8.66 14.64-4.25 4.24.71.71 4.24-4.25-.7-.7zM14.596 15.345l.707-.707 4.242 4.243-.707.707z'
        opacity='.3'
      />
      <path d='m21.67 18.17-5.3-5.3h-.99l-2.54 2.54v.99l5.3 5.3c.39.39 1.02.39 1.41 0l2.12-2.12a.996.996 0 0 0 0-1.41zm-2.83 1.42-4.24-4.24.71-.71 4.24 4.24-.71.71z' />
