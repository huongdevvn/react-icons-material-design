...
export default function IconPrecisionManufacturingTwoTone({ size = '1em', color = 'currentColor', ...restProps }) {
  return (
    <svg
    ...
    <path d='m6.71 10 2.46 8h1.94l-4.3-8z' opacity={0.3} />
    <circle cx={6} cy={7} r={1} opacity={0.3} />
