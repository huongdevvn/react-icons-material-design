...
export default function IconMarkAsUnreadTwoTone({ size = '1em', color = 'currentColor', ...restProps }) {
  return (
    <svg
    ...
    <path d='M13.5 13.33 20 10H7z' opacity={0.3} />
    <path d='M7 12v7h13v-7l-6.5 3.33z' opacity={0.3} />
