...
export default function icPerson4TwoTone({ ...restProps }) {
  return (
    <svg
    ...
    >
      <path
        d='M12 10c1.1 0 2-.9 2-2V5.5h-4V8c0 1.1.9 2 2 2zM17.48 16.34C16.29 15.73 14.37 15 12 15c-2.37 0-4.29.73-5.48 1.34-.32.16-.52.5-.52.88V18h12v-.78c0-.38-.2-.72-.52-.88z'
        opacity='.3'
      />
