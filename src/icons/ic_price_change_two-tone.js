...
export default function icPriceChangeTwoTone({ ...restProps }) {
  return (
    <svg
    ...
    >
      ...
      <path d='M8 17h2v-1h1c.55 0 1-.45 1-1v-3c0-.55-.45-1-1-1H8v-1h4V8h-2V7H8v1H7c-.55 0-1 .45-1 1v3c0 .55.45 1 1 1h3v1H6v2h2v1zM16 8l-2 2h4zM18 14.25h-4l2 2z' />
    </svg>
  );
}
