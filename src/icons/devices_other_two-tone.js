...
export default function IconDevicesOtherTwoTone({ size = '1em', color = 'currentColor', ...restProps }) {
  return (
    <svg
    ...
    <path d='M17 10h4v8h-4z' opacity={0.3} />
    <circle cx={11} cy={16} r={1.5} opacity={0.3} />
