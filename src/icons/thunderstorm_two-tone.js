...
export default function IconThunderstormTwoTone({ size = '1em', color = 'currentColor', ...restProps }) {
  return (
    <svg
    ...
    <path
      d='m17.73 9.01-1.53-.14-.25-1.52C15.63 5.44 13.94 4 12 4c-1.44 0-2.77.78-3.48 2.04l-.49.87-.99.13A3.51 3.51 0 0 0 4 10.5C4 12.43 5.57 14 7.5 14h10a2.5 2.5 0 0 0 2.5-2.5c0-1.28-.99-2.37-2.27-2.49z'
      opacity={0.3}
    />
