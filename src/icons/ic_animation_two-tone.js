...
export default function icAnimationTwoTone({ ...restProps }) {
  return (
    <svg
    ...
    >
      <path
        d='M5 12a5.002 5.002 0 0 0 7 7c-3.87 0-7-3.13-7-7zM15 4c-1.13 0-2.16.37-3 1 3.87.01 7 3.14 7 7a5.002 5.002 0 0 0-4-8z'
        opacity='.3'
      />
      <path
        ...
        opacity='.3'
      />
      <path d='M8 9a5.002 5.002 0 0 0 7 7c-3.87-.01-7-3.14-7-7z' opacity='.3' />
