...
export default function IconFace3TwoTone({ size = '1em', color = 'currentColor', ...restProps }) {
  return (
    <svg
    ...
    <path
      d='M16.5 8c.73 0 1.41-.25 1.99-.65-1.27-1.77-3.23-3-5.49-3.28v.43C13 6.43 14.57 8 16.5 8zM11 4.5v-.43a7.964 7.964 0 0 0-5.49 3.28c.58.4 1.26.65 1.99.65C9.43 8 11 6.43 11 4.5zM2.75 15.8 2.19 22H12c-4.18 0-7.75-2.56-9.25-6.2zM12 22h9.81l-.56-6.2C19.75 19.44 16.18 22 12 22z'
      opacity={0.3}
    />
